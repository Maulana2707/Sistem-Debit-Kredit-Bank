...
<div class="topnav" id="myTopnav">
  <img style="float:right; right:1" src="../img/lg.jpg" height="44" width="204.8">
    ...
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>My Balance</h4><p id="balance">Rp. <?php echo $balance ?></p></center></td>
        </tr>
      </table>
    </td>
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Total Limit</h4><p id="tlimit">Rp. <?php echo $online_limit + $card_limit ?></p></center></td>
        </tr>
      </table>
    </td>
  </tr>
    ...
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Online Transaction Limit</h4><p id="olimit">Rp. <?php echo $online_limit ?></p></center></td>
        </tr>
      </table>
    </td>
    <td>
      <table style="border-collapse: collapse; border: 1px solid black">
        ...
        <tr>
          ...
          <td ><center><h4>Card Limit</h4><p id="climit">Rp. <?php echo $card_limit ?></p></center></td>
        </tr>
      </table>
    </td>
  </tr>
